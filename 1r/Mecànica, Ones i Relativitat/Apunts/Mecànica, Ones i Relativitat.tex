...
\begin{itemize}
    ...
    Parlem de sistemes inercials en aquells que es troben en repòs o a una velocitat constant i es compleixen les lleis de Newton sense falta d'aplicar cap força externa. I els no inercials aquells que tenen una acceleracció aplicada ($A'$) i hem de "crear" una força $F = mA'$ ficticia.
