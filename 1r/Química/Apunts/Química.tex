...
% Corba de probabilidad

La línea blava indica el màxim de probabilitat i la tronja la meitat. Veiem que com anem afegint més orbitals n ($1_s, 2_s, 3_s$) la gràfica té \textbf{nòdes} que indiquen la \textbf{separació entre capes}, el nombre de nòdes és $\boxed{n - l - 1}$
